...
#define _EXT extern
   ...
   _EXT  CK_BBOOL       pksc8_Check_PublicKeyInfoLMS(LMS_PUBLIC_KEY* sMlKemPublicKey, CK_CHAR_PTR data, CK_ULONG size);
   ...
   _EXT  CK_BBOOL       pksc8_Build_PublicKeyInfoLMS(LMS_PUBLIC_KEY* sLmspublickey);
